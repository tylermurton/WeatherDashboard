...
function error() {
    //cant geolocate and no previous searchs, give miami
...
$('input').keypress(function (e) {
    ...
    if(key == 13)  // the enter key code
     {
       $('#searchbtn').click();
       $(this).attr("disabled", "disabled"); //makes it so you're done typing when you press enter
